...
# return all time slots based on permit number, clinic and date
...
# create time slots of a doctor on a specific date
...
# update a doctor's time slots on a specific date
